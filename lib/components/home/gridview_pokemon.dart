    ...
    return SizedBox(
      child: Column(
        children: [
          ...
          const Responsive(
              small: GridViewPokemon(crossAxisCount: 1, childAspectRatio: 1.7),
              medium: GridViewPokemon(crossAxisCount: 2, childAspectRatio: 1.5),
              large: GridViewPokemon(crossAxisCount: 3, childAspectRatio: 1.5),
              xlarge: GridViewPokemon(crossAxisCount: 5, childAspectRatio: 1.5)),
        ],
      ),
    );
  }
